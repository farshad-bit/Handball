...
<form action="./../controller/spielorte.php" method="POST">
    Spielort: <input type="text" name="arena"><br>
    Land: <input type="text" name="country"><br>
    Kapazitaet: <input type="number" name="kapazitaet"><br>
...
<table>
    <tr>
        ...
        <th><a href="./../controller/spielorte.php?sortk=<?php if(!empty($sortk)) {echo $sortk;}; ?>">Kapazität</a></th>
    </tr>
    <?php 
    ...
    <tr>
        ...
        <td><?php echo $spielort['kapazitaet']; ?></td>
